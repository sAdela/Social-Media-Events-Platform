...
export default observer(function ActivityForm(){
    ...
    const {createActivity, updateActivitiy, loading, loadActivity, loadingInitial } = activityStore;
    ...
    function handleSubmit(){
        if (activity.id.length === 0){
            ...
            updateActivitiy(activity).then(() => history.push(`/activities/${activity.id}`));
        } 
    }
